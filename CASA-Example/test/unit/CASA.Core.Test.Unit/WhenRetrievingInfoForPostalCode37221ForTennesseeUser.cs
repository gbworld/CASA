...
using CASA.Core.Test.Unit.Helper;
...
namespace CASA.Core.Test.Unit
{
    ...
    public class WhenRetrievingInfoForPostalCode37221ForTennesseeUser : CoreTestBase
    {
        ...
        public static void Initialize(TestContext context)
        {
            ...
            // TODO: This should be mocked based on dependency injection standards
            IPostalCodeRepository postalCodeRepository = new PostalCodeRepositoryMock();
            ICountryRepository countryRepository = new CountryRepositoryMock();
            IStateRepository stateRepository = new StateRepositoryMock();
            IClientRouter clientRouter = new ClientRouterMock();
            IUserAuthenticator userAuthenticator = new AuthenticatorMock();
